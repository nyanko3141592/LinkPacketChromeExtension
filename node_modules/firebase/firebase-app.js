!function (e, t) {
    ...
    var m = (y.prototype.create = function (e) {
        ...
        var n, i = t[0] || {}, o = this.service + "/" + e, e = this.errors[e],
    ...
    var L = "[DEFAULT]", S = (R.prototype.get = function (e) {
        ...
        var t = o({identifier: L, optional: !1}, e), e = t.identifier, r = t.optional,
        ...
        try {
            for (var n = h(this.instancesDeferred.entries()), i = n.next(); !i.done; i = n.next()) {
                var o = u(i.value, 2), a = o[0], s = o[1], l = this.normalizeInstanceIdentifier(a);
                try {
    ...
    function F(e, t) {
        ...
        if (!(t < e.logLevel)) {
            var i = (new Date).toISOString(), o = x[t];
    ...
    var V = ((V = {})["no-app"] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()", V["bad-app-name"] = "Illegal App name: '{$appName}", V["duplicate-app"] = "Firebase App named '{$appName}' already exists", V["app-deleted"] = "Firebase App named '{$appName}' already deleted", V["invalid-app-argument"] = "firebase.{$appName}() takes either no argument or a Firebase App instance.", V["invalid-log-argument"] = "First argument to `onLog` must be null or a function.", V),
        U = new m("app", "Firebase", V), M = "@firebase/app", W = "[DEFAULT]",
        ...
        $ = new H("@firebase/app"), Y = (Object.defineProperty(K.prototype, "automaticDataCollectionEnabled", {
            get: function () {
            ...
            return void 0 === t && (t = W), this.checkDestroyed_(), this.container.getProvider(e).getImmediate({identifier: t})
    ...
    function Z(l) {
        var c = {}, u = new Map, p = {
            ...
            }, apps: null, SDK_VERSION: J, INTERNAL: {
                registerComponent: o, removeApp: function (e) {
                    delete c[e]
        ...
        function o(r) {
            ...
            u.set(i, r), "PUBLIC" === r.type && (n = function (e) {
                if (void 0 === e && (e = f()), "function" != typeof e[i]) throw U.create("invalid-app-argument", {appName: i});
                return e[i]()
    ...
    return re.registerVersion("firebase", "8.2.2", "app"), re
});
